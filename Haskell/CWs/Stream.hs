-- Functional streams https://www.codewars.com/kata/functional-streams/train/haskell
...
primeS = sieveS $ fromS 2
sieveS (p :> xs) = p :> sieveS (filterS (\x -> x `mod` p /= 0) xs)